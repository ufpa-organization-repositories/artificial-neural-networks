from trabalho_final.backpropagation_final import train_backpropagation, apply_backpropagation, plotErrors_comparative
...
# apply_backpropagation(entradas=entradas, pesos0=pesos0, pesos1=pesos1, error_array=error_array)
